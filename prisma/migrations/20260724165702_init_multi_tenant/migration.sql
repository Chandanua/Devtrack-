-- CreateEnum
CREATE TYPE "AuthProvider" AS ENUM ('credentials', 'github', 'google');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('task_assigned', 'due_reminder', 'deadline_approaching', 'task_overdue', 'comment_mention', 'status_change', 'priority_update', 'project_announcement', 'org_invite');
...
-- AddForeignKey
ALTER TABLE "org_memberships" ADD CONSTRAINT "org_memberships_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "profiles"("id") ON DELETE CASCADE ON UPDATE CASCADE;
